...
const rules: Array<[RegExp, string]> = [
  ...
  [/Usa el correo y contraseña asignados\. No hay registro: el rol viene directamente desde la base de datos\./g, 'Use your assigned email and password. There is no sign-up: your role comes directly from the database.'],
  ...
  [/Integramos la capa analítica de la carpeta B-612: 24 KPIs, 6 dimensiones, scoring ponderado, tiers, gaps, trazabilidad e insights para dirección académica\./g, 'We integrate the B-612 analytics layer: 24 KPIs, 6 dimensions, weighted scoring, tiers, gaps, traceability, and insights for academic direction.'],
  [/Exportar/g, 'Export'],
  ...
  [/[UÚ]ltimos registros/g, 'Latest records'],
  ...
  [/Selecciona un compañero para comenzar la evaluación\./g, 'Select a teammate to start the evaluation.'],
  [/No hay criterios de evaluación configurados\./g, 'There are no evaluation criteria configured.'],
  ...
  [/Tu constelación sigue creciendo/g, 'Your constellation keeps growing'],
  [/Historias completadas/g, 'Completed stories'],
  [/Misión del sprint/g, 'Sprint mission'],
  [/Acuerdos de la tripulación/g, 'Crew agreements'],
  [/Documentación del clan/g, 'Clan documentation'],
  [/Publicado para todas las células/g, 'Published for all cells'],
  [/Contenido Markdown/g, 'Markdown content'],
  [/Lo esencial también vive en lo que construimos juntos\./g, 'What is essential also lives in what we build together.'],
  [/Continúa aprendiendo, construyendo y creciendo con tu tripulación\./g, 'Keep learning, building, and growing with your crew.'],
  [/Sesión real/g, 'Real session'],

  // Domain nouns (safe with word boundaries)
  ...
  [/\bParticipaciones\b/g, 'Participation'],
  [/\bDistribuci[oó]n\b/g, 'Distribution'],
  [/\bCiclo Scrum\b/g, 'Scrum cycle'],
  [/\bBoard interno\b/g, 'Internal board'],
  [/\bConfirmada\b/g, 'Confirmed'],
  [/\bEntendido\b/g, 'Got it'],
  [/\bPriorizar\b/g, 'Prioritize'],
  [/\bRama dev\b/g, 'dev branch'],
  [/\bTodas las c[eé]lulas\b/g, 'All cells'],
  [/\bCell seleccionada\b/g, 'Selected cell'],
  [/\b6 dimensiones\b/g, '6 dimensions'],
  [/\bCells activas\b/g, 'Active cells'],
  [/\bhoy\b/g, 'today'],
  [/\bHoy\b/g, 'Today'],
  [/\bdías\b/g, 'days'],
  [/\bdía\b/g, 'day'],
...
declare global {
  interface Window { __b612EnglishUiInstalled?: boolean }
}
